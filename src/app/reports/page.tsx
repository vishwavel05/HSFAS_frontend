      ...
      <div className="flex-1 space-y-4 px-5 py-5">
        <div className="flex justify-end mb-6">
          <select 
            ...
            className="border border-surface-border rounded-lg px-4 py-2 bg-white text-navy focus:outline-none focus:border-brand-primary"
          >
        ...
        <h2 className="text-xl font-bold text-navy mb-4">Key Metrics</h2>
